...
public static class UserUpstreamApiKeys
{
    ...
    static UserUpstreamApiKeys()
    {
        ...
        Register(new("anthropic_api", "anthropic", "Anthropic", "https://console.anthropic.com/", new("To use the Anthropic Claude LLM backend, set your API key below.\n<br>This allows you to use Claude models for text generation.")));
        Register(new("openai_api", "openai", "OpenAI", "https://platform.openai.com/api-keys", new("To use OpenAI models via the Remote LLM backend, set your API key below.\n<br>This allows you to use GPT models for text generation.")));
    }
}
